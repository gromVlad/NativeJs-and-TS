...
//npm / yarn / pnpm (зависемости централизованы и использует только ссылки на эти зависемости если много проектов создано сразу а не дублировать все модули, быстрая работа) ...

//NPM - утилита которая обращаеться к registry (большой регистр информации с API в котором храняться пакеты и по запросу отдаеться необходимые)
//Также можно добовлять свои сборки делать их приватными (платная услуга)

//Работа
//Сначало при загрузке (npm i) пакетов он идет в кэш (для оптимизации работы)

//-----------------------
//Авторизация и профиль
//npm whoami - проверка зареган или нет
//npm login -> user_ login_
//npm profile get - получить профиль
//npm team - работа c командой
//npm logout - выйти
...
/* {
    ...
    "name": "book-app", - название
    "version": "1.0.0", - версия пакета
    "description": "Cool book app",
    "main": "app.js", - точка входа
    ...
    "repository": {
      "type": "git",
      "url": "git+https://github.com/AlariCode/8-javascript-advanced-1.git"
    },
    "keywords": [
      "books"
    ],
      ...
      "license": "ISC",
      "bugs": {
      "url": "https://github.com/AlariCode/8-javascript-advanced-1/issues"
    },
...
//набор стороних зависемостей
//npm search http  (axios,express ...)

//Устанавливаем пакет
//npm i axios

// Появился dependencies - указываються все зависемости которые нужны для продакшина и без них приложения не запуститься
/* "dependencies": {
  "axios": "^1.3.2"
}, */
//^1.3.2 - 1)мажорная версия / 2) минорная (фичи) / 3) фикс версия (фикс багов) ,  ^ - ограничивает мажорную версию, ~ приблизительно (изменения мажорной и минорной версии недопустимо)

//Появился package-lock.json - который описывает зависемости после установки (зависемости зависемостей и т.д.)

//Появилось node_modules - все модули которые установили (их надо перестить в ignor git)

//npm i - обновить зависемости
//npm ci  - использовать текущие версии зависемостей

//аудит по безопасности пакетов
//npm audit
//npm audit fix --forse - установит пакеты самых безопасных версии
...
//удалить зависемости
//npm uni axios / либо в ручном режиме удалить строку dependencies и npm i (обновить зависемости)

//установить глобально
//npm i -g ...

//установить dev зависемости (для разработки, при сборке они не учитываються)
//npm i -D
